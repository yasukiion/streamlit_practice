...
# フォルダのパスを指定
#予測用のフォルダ
UPLOAD_FOLDER = "nobutair/ceremony/uploads"
#学習用
DATA_FOLDER = "nobutair/ceremony/data"
#モデルの場所
MODEL_FOLDER = "nobutair/ceremony/my_model"
#なぜか作られてしまうゴミフォルダ
MACOSX = "nobutair/ceremony/uploads/__MACOSX"
#csvファイルを保存するフォルダ
# 現在の日付を取得する
