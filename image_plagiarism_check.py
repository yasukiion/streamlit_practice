...
# APIキーを設定する
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "./ceremony/authority/client_secret_569573701758-7ld71vfmgde35im51hk7b68lbjbrq85c.apps.googleusercontent.com.json"
# プロジェクトIDを設定する
